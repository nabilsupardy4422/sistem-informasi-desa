...
<head>
    ...
    <title>Lupa Password - SI Desa Premium</title>
    ...
    <style>
        ...
        .input-neo:focus {
            ...
            box-shadow: 0 0 0 4px rgba(139, 92, 246, 0.15), 0 2px 10px rgba(0, 0, 0, 0.02);
...
<body class="min-h-screen text-slate-800 antialiased selection:bg-violet-500 selection:text-white flex items-center justify-center">

    <div class="fixed inset-0 z-[-1] lg:hidden bg-gradient-to-br from-slate-50 to-slate-200">
        <div class="absolute top-[-10%] left-[-10%] w-72 h-72 bg-violet-400 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-blob"></div>
        <div class="absolute top-[20%] right-[-10%] w-72 h-72 bg-fuchsia-400 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-blob animation-delay-2000"></div>
    </div>
    ...
    <div class="w-full max-w-[1400px] h-[100vh] lg:h-[90vh] lg:max-h-[900px] flex lg:rounded-[3rem] lg:overflow-hidden lg:shadow-2xl lg:shadow-slate-300/50 bg-white relative m-4">
        ...
        <div class="hidden lg:flex w-[45%] relative overflow-hidden bg-[#0F172A] flex-col justify-between p-16">
            ...
            <div class="absolute top-0 -left-4 w-72 h-72 bg-violet-600 rounded-full mix-blend-screen filter blur-[100px] opacity-70 animate-blob"></div>
            <div class="absolute top-0 -right-4 w-72 h-72 bg-fuchsia-500 rounded-full mix-blend-screen filter blur-[100px] opacity-70 animate-blob" style="animation-delay: 2s"></div>
            <div class="absolute -bottom-8 left-20 w-72 h-72 bg-purple-600 rounded-full mix-blend-screen filter blur-[100px] opacity-70 animate-blob" style="animation-delay: 4s"></div>
            ...
            <div class="relative z-10 animate-fade-in-up stagger-1">
                <a href="{{ url('/') }}" class="inline-flex items-center gap-3 group">
                    <div class="w-12 h-12 bg-gradient-to-br from-violet-500 to-fuchsia-400 rounded-2xl flex items-center justify-center text-white shadow-lg group-hover:scale-105 transition-transform">
                        <i class="fa-solid fa-building-columns text-xl"></i>
                    </div>
                    <div>
                        <h2 class="font-display font-black text-2xl text-white tracking-tight leading-none">SI Desa</h2>
                        <span class="text-[10px] uppercase tracking-widest text-fuchsia-400 font-bold">Portal Utama</span>
                    </div>
                </a>
            </div>
            ...
            <div class="relative z-10 my-auto animate-fade-in-up stagger-2">
                <div class="inline-flex items-center gap-2 bg-white/10 border border-white/10 px-4 py-2 rounded-full mb-6 backdrop-blur-md">
                    ...
                    <span class="text-[10px] font-black text-white uppercase tracking-widest">Pemulihan Keamanan</span>
                </div>

                <h1 class="text-5xl xl:text-6xl font-display font-black text-white leading-[1.1] mb-6 tracking-tight">
                    Reset Sandi <br>
                    <span class="text-transparent bg-clip-text bg-gradient-to-r from-fuchsia-400 to-violet-500">Dengan Aman.</span>
                </h1>

                <p class="text-slate-300 text-lg leading-relaxed max-w-md font-light">
                    Sistem informasi desa melindungi data Anda. Tautan pemulihan sandi hanya akan dikirimkan ke email administrator yang terdaftar.
                </p>
            </div>
            ...
            <div class="relative z-10 animate-fade-in-up stagger-3 flex items-center gap-4 border-t border-white/10 pt-8">
                ...
                <div class="text-sm text-slate-400 font-medium leading-tight">
                    Dilindungi oleh <br><span class="text-white font-bold">Enkripsi Sistem Terpadu</span>
                </div>
            </div>
        </div>
        ...
        <div class="w-full lg:w-[55%] flex flex-col items-center justify-center p-8 sm:p-12 lg:p-24 relative overflow-y-auto">
            ...
            <div class="w-full max-w-md mx-auto">
                <div class="lg:hidden text-center mb-10 animate-fade-in-up stagger-1">
                    <div class="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br from-violet-600 to-fuchsia-500 text-white mb-4 shadow-xl shadow-violet-500/20">
                        <i class="fa-solid fa-building-columns text-2xl"></i>
                    </div>
                    <h1 class="text-3xl font-display font-black text-slate-900 tracking-tight">SI <span class="text-violet-600">Desa</span></h1>
                </div>

                <div class="text-center lg:text-left mb-10 animate-fade-in-up stagger-1">
                    <h2 class="text-3xl md:text-4xl font-display font-black text-slate-900 mb-3 tracking-tight">Lupa Sandi? 🔐</h2>
                ...
                <form method="POST" action="{{ route('password.email') }}" class="space-y-6 animate-fade-in-up stagger-3">
                    @csrf
                    ...
                    <div>
                        ...
                        <div class="relative flex items-center group">
                            ...
                            >
                            <div class="absolute left-4 z-20 pointer-events-none text-slate-400 group-focus-within:text-violet-500 transition-colors">
                                <i class="fa-regular fa-envelope text-lg"></i>
                            </div>
                        </div>
                    </div>

                    <button type="submit" class="btn-neo w-full bg-gradient-to-r from-violet-600 via-fuchsia-500 to-violet-600 text-white py-4 rounded-2xl font-black text-base shadow-lg shadow-violet-500/30 flex items-center justify-center gap-2 group">
                        Kirim Tautan Reset
