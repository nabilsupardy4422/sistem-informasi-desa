...
<head>
    ...
    <title>404 - Halaman Tidak Ditemukan | SI Desa</title>
    ...
    <style>
        body {
            ...
            background:
                ...
                radial-gradient(circle at bottom left, rgba(14,165,233,0.12), transparent 35%),
...
<div class="max-w-6xl w-full animate-fade">
    ...
    <div class="bg-white/90 backdrop-blur-xl border border-white shadow-2xl rounded-[2.5rem] overflow-hidden animate-glow">
        ...
        <div class="grid lg:grid-cols-2 min-h-[700px]">
            ...
            <!-- LEFT -->
            <div class="relative overflow-hidden bg-gradient-to-br from-blue-700 via-blue-600 to-slate-800 text-white p-12 lg:p-16 flex flex-col justify-center">
                ...
                <div class="floating-orb w-72 h-72 bg-cyan-300 top-10 left-10 animate-float"></div>
                <div class="floating-orb w-80 h-80 bg-blue-400 bottom-10 right-10 animate-float" style="animation-delay:2s;"></div>
                ...
                <div class="relative z-10">
                    ...
                    <p class="text-blue-100 text-lg leading-relaxed max-w-xl">
                        ...
                        atau alamat URL yang dimasukkan tidak valid.
                    </p>
            ...
            <div class="p-10 lg:p-16 flex flex-col justify-center">
                ...
                <div class="w-28 h-28 rounded-[2rem] bg-blue-100 flex items-center justify-center text-6xl mb-8 animate-float">
                    🔍
                </div>
                ...
                <p class="text-slate-500 text-lg leading-relaxed mb-10">
                    Jangan khawatir. Anda masih dapat kembali ke halaman utama
                    atau menggunakan fitur layanan publik SI Desa.
                </p>

                <div class="space-y-4">

                    <a href="{{ route('home') }}"
                        class="btn-modern block w-full bg-blue-600 hover:bg-blue-700 text-white text-center py-4 rounded-2xl font-bold text-lg shadow-lg">
                        Kembali ke Beranda
                    </a>
                    ...
                    <a href="{{ route('login') }}"
                        class="btn-modern block w-full bg-emerald-600 hover:bg-emerald-700 text-white text-center py-4 rounded-2xl font-bold">
                        Login Administrator
                    </a>
                ...
                <div class="mt-10 pt-8 border-t border-slate-200">
                    ...
                    <ul class="space-y-3 text-slate-500">
                        ...
                        <li>• Konten sudah tidak tersedia</li>
                        <li>• Link yang diakses sudah kedaluwarsa</li>
                    </ul>
